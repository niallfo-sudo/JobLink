          ...
          <div className="account-layout">
            ...
            <div className="account-content">
              ...
              {accountTab === "payments" && <>
                ...
                <DemoLifecycleControls jobs={demoEligibleJobs} documents={generatedDocuments} payments={paymentRecords} actionId={demoLifecycleAction} feedback={demoLifecycleFeedback} onRun={(job, action) => void runDemoLifecycle(job, action)} />
