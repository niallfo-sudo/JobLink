...
export async function POST() {
  ...
  return Response.json({ connected: true, payoutsEnabled: true, profile: updated, demo: true, message: "Demo payout destination enabled. No bank account was connected." });
}
